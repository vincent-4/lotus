...
class TestSemMap(BaseTest):
    ...
    def test_sem_map_multiple_samples(self):
        ...
        result_df = df.sem_map(
            "What is a similar course to {Course Name}. Be concise.", nsample=nsample, temperature=0.7
        )
    ...
    def test_sem_map_explanations(self):
        ...
        result_df_single = df.sem_map(
            "What is a similar course to {Course Name}. Be concise.", return_explanations=True
        )
        ...
        result_df_multi = df.sem_map(
            "What is a similar course to {Course Name}. Be concise.", nsample=nsample, return_explanations=True
        )
